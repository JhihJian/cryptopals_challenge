...
def process_user_input(input_string):
    ...
    return aes_cbc_encrypt(result.encode('ascii'),random_key,IV)
...
print(check_user_auth(user_encrypt_data))
print("进行攻击")
attack_key_bytes=xor_bytes(b'%3Badmin%3Dtrue%',b'%3Ba;admin=true;')
user_encrypt_data=user_encrypt_data[0:16]+xor_bytes(user_encrypt_data[16:32],attack_key_bytes)+user_encrypt_data[32:]
# attacked_user_encrypt_data_list = attack_user_encrypt_data(attack_key_bytes,user_encrypt_data)
# print(attacked_user_encrypt_data_list)
# for attacked_user_encrypt_data in attacked_user_encrypt_data_list:
print(check_user_auth(user_encrypt_data))
