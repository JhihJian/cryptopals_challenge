...
from S2C10_Impl_CBC_Mode import aes_ecb_encrypt,aes_ecb_decrypt,xor_data
from Crypto import Random
from Crypto.Cipher import AES
import struct
key=secrets.token_bytes(16)
nonce_v=secrets.randbelow(2**64)
class Oracle:
    ...
    def edit(self, ciphertext, offset, new_text):
        ...
        for block in range(start_block, end_block + 1):
            ...
            keystream += aes_ecb_encrypt(self._key, struct.pack('<QQ', 0, block))
    ...
    def encrypt(self, plaintext):
        ...
        return aes_ctr_encrypt(plaintext, self._key, 0)[0]
...
def main():
    with open("resources/S4C25_input.txt") as input_file:
